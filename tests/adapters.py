...
from cs336_basics.module import (Embedding, Linear, MultiHeadAttention, RMSNorm, RotaryPositionalEmbedding,
                                 scaled_dot_product_attention, silu, softmax, SwiGLU)
from cs336_basics.optimizer import AdamWOptimizer, cosine_aneealing_lr_schedule, gradient_clipping
...
def run_multihead_self_attention(
    ...
    mha.load_state_dict(
        {
            'QKV.weight': torch.vstack((q_proj_weight, k_proj_weight, v_proj_weight)),
...
def run_multihead_self_attention_with_rope(
    ...
    mha = MultiHeadAttention(d_model, num_heads, rope=rope)
    mha.load_state_dict(
        {
            'QKV.weight': torch.vstack((q_proj_weight, k_proj_weight, v_proj_weight)),
            'O.weight': o_proj_weight,
...
def run_get_lr_cosine_schedule(
    ...
    """
    return cosine_aneealing_lr_schedule(min_learning_rate, max_learning_rate, it, warmup_iters, cosine_cycle_iters)
